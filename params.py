...
BOW_dictionary_size = 1024  #  in general, larger = better performance, but potentially slower，512
...
BOW_fixed_feature_per_image_to_use = 0 # reduce to improve speed, set to 0 for variable number 100
